...
export const SEGMENTS: Segment[] = [
  { id: 'intro', src: [24.0, 26.2], speed: 1, caption: { text: '開いた瞬間、もう入力できる', top: 0.36 } },
  { id: 'add3', src: [26.2, 31.2], speed: 1.4, caption: { text: 'Returnで、次々に', top: 0.36 }, sfx: [{ file: 'sfx-tap', at: 0.3 }, { file: 'sfx-tap', at: 1.7 }, { file: 'sfx-tap', at: 3.1 }] },
  { id: 'others', src: [32.4, 39.0], speed: 1.5, caption: { text: '今日・明日・いつか', sub: '区分は、それだけ', top: 0.36 }, sfx: [{ file: 'sfx-tap', at: 1.8 }, { file: 'sfx-tap', at: 4.0 }] },
  { id: 'swipe', src: [40.0, 45.0], speed: 1.2, caption: { text: '右スワイプで、完了', top: 0.62 }, sfx: [{ file: 'sfx-pop', at: 3.25 }] },
  { id: 'drag', src: [45.2, 49.5], speed: 1, caption: { text: '並び順が、そのまま実行順', sub: '見出しを越えれば区分が変わる', top: 0.62 }, sfx: [{ file: 'sfx-pop', at: 2.4 }] },
  { id: 'add2', src: [50.8, 55.0], speed: 1.7, caption: { text: '雑に放り込んで', top: 0.36 }, sfx: [{ file: 'sfx-tap', at: 1.06 }, { file: 'sfx-tap', at: 2.06 }] },
